...
assert.doesNotMatch(html, /unsafe-eval|unsafe-inline/i);
...
console.log('Security checks passed: restrictive production CSP, no unsafe script policy, no runtime HTML injection, no known secret patterns in shipped source.');
